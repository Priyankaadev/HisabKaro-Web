                ...
                <div className='signup-details flex flex-col justify-center  '>
                   ...
                   <p className='text-[#53ABFF] text-[30px] font-bold mt-3'>Login</p>
                    ...
                    <div className='flex text-[12px] justify-between '>
                          <div className='flex items-center  '>
                           ...
                           <label for="remember-me" class="ms-2  font-medium text-gray-900 ">Remember me</label>
                   </div>
                  ...
                  <p className='text-[#61A9EA]'>Reset Password</p>
                      ...
                      <div className='buttons flex flex-col mt-2 gap-3 '>
                        ...
                        <button 
                        className='login-number-button border-2 rounded-lg  p-3 border-[#5699D5] bg-[#F3F9FF] text-[#61A9EA]'>
